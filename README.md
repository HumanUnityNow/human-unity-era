...
@keyframes jitter{ 0%,100%{transform:translate(0,0)} 25%{transform:translate(.35px,-.4px)}
  50%{transform:translate(-.45px,.25px)} 75%{transform:translate(.25px,.35px)} }
.ghostBehind img{
...
<section class="hero" aria-label="Emergency broadcast">
  ...
  <div class="layer ghostBehind" style="opacity:1">
    <img src="images/emblem-burnt.jpeg" alt="HUE emblem (ghost)">
  </div>
  <div class="layer winTS ts"><div class="text"><h1>TIME’S UP</h1></div></div>
  <div class="layer winS1 s1"><div class="text"><p>We are the people. We are the majority.<br/>We are the ones that matter.</p></div></div>
  <div class="layer winS2 s2"><div class="text"><p>The time of allowing ego-driven “world leaders” to lead us into war for profit is over.<br/>We, the people of the world, will have the final say.</p></div></div>
  <div class="layer winEm emblemMain"><img src="images/emblem-burnt.jpeg" alt="Human Unity Era emblem"></div>
  <div class="deadMask"></div>
  <div class="layer winDead ghostEmblem"><img src="images/emblem-burnt.jpeg" alt="HUE emblem (ghost flicker)"></div>
</section>
<script>
(function(){
